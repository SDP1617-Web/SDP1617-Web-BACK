...
public enum ErrorCode implements ApiErrorCode {
    ...
    INVALID_REQUEST_BODY("COMMON400_BODY", "요청 본문을 읽을 수 없습니다.", HttpStatus.BAD_REQUEST),
    MISSING_REQUEST_PARAMETER("COMMON400_PARAM", "필수 요청 파라미터가 누락되었습니다.", HttpStatus.BAD_REQUEST),
